	...
	return (
		<main>
			<section
				...
				<HeroContent
					position='bottom-[20%] left-4 w-1/2 md:w-1/3 z-20'
					title={
						category === 'orhangen'
							? 'Örhängen'
			...
			<section className='bg-navbar-link-hover-color pt-10 pb-14 md:pb-20'>
				<section className='mx-auto font-lora w-[90vw] md:w-[80vw]'>
					...
					{category === 'ringar' ? (
						...
						<p className='text-xs sm:text-sm'>
							Alla örhängen är handtillverkade, unika och finns i endast några få exemplar. Med
							design från AnnaMaria Silverdesign vet du att du får ett halsband som sticker ut, tar
							plats och talar för sig självt. Se ett urval av örhängen nedan – alla tillverkade i
							återvunnet silver.
						</p>
					) : category === 'halsband' ? (
						<p className='text-xs sm:text-sm'>
							Alla halsband är handtillverkade, unika och finns i endast några få exemplar. Med
							design från AnnaMaria Silverdesign vet du att du får ett smycke som sticker ut, tar
							plats och talar för sig självt. Se ett urval av halsband och halsringar nedan – alla
							tillverkade i återvunnet silver.
						</p>
					) : category === 'armband' ? (
						<p className='text-xs sm:text-sm'>
							Alla armband är handtillverkade, unika och finns i endast några få exemplar. Med
							design från AnnaMaria Silverdesign vet du att du får ett smycke som sticker ut, tar
							plats och talar för sig självt. Se ett urval av armband och armringar nedan – alla
							tillverkade i återvunnet silver.
						</p>
					) : (
						<p className='text-xs sm:text-sm'>
